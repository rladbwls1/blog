    ...
    <head>
		...
		<script>
			...
			function deleteFile(button) {
	              var fileGroup = button.closest('.file-group');
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="d-grid gap-2 col-6 mx-auto">
						      <b>글수정</b><br>
						      <form method="post" name="writeform" action="/qa/updatePro" onsubmit="return writeSave()">
						        <table class="table table-bordered" style="max-width: 700px;">
						          <tr>
						            <td width="70" class="text-center">이름</td>
						            <td class="pl-2">
						              <input type="text" size="10" maxlength="10" name="writer" value="${article.writer}" class="form-control">
						          ...
						          <tr>
						            ...
						            <td class="pl-2">
						              <input type="text" size="40" maxlength="50" name="title" value="${article.title}" class="form-control">
						            </td>
						          </tr>
						          <tr>
						            <td width="70" class="text-center">내용</td>
						            <td class="pl-2">
						              <textarea name="content" id ="content" rows="13" cols="40" class="form-control">${article.content}</textarea>
						            </td>
						          </tr>
						          <tr>
		                            ...
		                            <td width="330" id="files">
		                                <c:forEach var="file" items="${fileList}">
		                                        <input type="text" size="40" maxlength="30" name="existingFiles" class="form-control" value="${file.orgname}" readonly>
		                                </c:forEach>
		                            </td>
		                        </tr>
						          <tr>
						          ...
						          <tr>
						            <td colspan="2" class="text-center">
						              ...
						              <input type="button" class="btn btn-secondary" value="목록보기" onclick="document.location.href='/qa/list'">
						            </td>
						          </tr>
						        </table>
						      </form>
