                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                            	1 : 1 문의하기
                            		<a href="/qa/writeForm" class="btn btn-secondary">작성하기</a>
                            </div>
                        </div>
                        <div class="card mb-4">
										   ...
										   <tr height="30">
											    <td  width="250" >
												    <c:if test="${article.re_level > 0}">
												      ...
												      <a href="content?num=${article.num}" style="text-decoration: none;  color: black;">${article.title}</a> 
												   <c:if test="${article.isfile > 0}">
											        	<img src="/resources/img/IMG.png" border="0"  height="15">
											      </c:if> 
											    ...
											    <td align="center"  width="150"><fmt:formatDate value="${article.reg_date}" type="date" dateStyle="long"/></td>
										  </tr>
									    </c:forEach>
                                    </tbody>
                                </table>
