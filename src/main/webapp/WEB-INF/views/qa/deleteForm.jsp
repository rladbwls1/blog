                    ...
                    <div class="container-fluid px-4">
                        ...
                        <body class="bg-light">
						  <div class="container mt-4">
						    <center>
						      <b>글삭제</b><br>
						      <form method="POST" name="delForm" action="/qa/deletePro" onsubmit="return deleteSave()">
						        <table class="table table-bordered">
						          ...
						          <tr>
						            <td class="text-center">
						              비밀번호 :
						              <input type="password" name="passwd" class="form-control" maxlength="12">
						          ...
						          <tr>
						            <td class="text-center">
						              ...
						              <input type="button" class="btn btn-secondary" value="글목록" onclick="document.location.href='/qa/list?num=${num}'">
						            </td>
						          </tr>
						        </table>
						      </form>
