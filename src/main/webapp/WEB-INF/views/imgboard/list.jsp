                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                restaurant
                                <c:if test = "${sessionScope.memId != null }">
                                	<a href="/imgboard/writeForm" class="btn btn-secondary">작성하기</a>
		    					</c:if>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                        <c:forEach var="dto" items="${list}">
										    <tr>
										        <td>
										        	<a href="/imgboard/content?num=${dto.num}" style="text-decoration: none;  color: black;">
											        <img src="/resources/file/board/${dto.img_main}" width="339" height ="203">
											        </a>
											        <a href="/imgboard/content?num=${dto.num}" style="text-decoration: none;  color: black;"> ${dto.subject}</a></td>
										        <td>${dto.writer}</td>
