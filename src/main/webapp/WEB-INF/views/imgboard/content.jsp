			...
			<tr>
				...
				<c:if test = "${fileList != null }">
					<c:forEach var="fileDTO" items="${fileList }">
						<img src="/resources/file/board/${fileDTO.filename }" width="150">
					</c:forEach>
				</c:if>
				</td>
			<tr>
					<td>
						<c:if test="${id != null && id.equals(dto.writer)}"> 
						<input type="button" class="btn btn-success" value="글 수정" 
						onclick="document.location.href='/imgboard/updateForm?num=${dto.num}'">  
						<input type="button" class="btn btn-danger" value="글 삭제"
						onclick="document.location.href='/imgboard/deleteForm?num=${dto.num}'">
						</c:if>
