                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
		                <c:if test="${sessionScope.memId==null }">
							...
							<li><a href="/m/signup" class="dropdown-item">SignUp</a></li>
						</c:if>
                        <c:if test="${sessionScope.memId!=null }">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Welcome to the blog!</li>
                        </ol>
                        <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
						  <div class="carousel-inner">
						    <div class="carousel-item active">
						      <img src="/resources/img/111.jpg" class="d-block w-100" height="600px;">
						    </div>
						    <div class="carousel-item">
						      <img src="/resources/img/222.jpg" class="d-block w-100" height="600px;" >
						    </div>
						    <div class="carousel-item">
						      <img src="/resources/img/333.jpg" class="d-block w-100" height="600px;">
						    </div>
						  </div>
